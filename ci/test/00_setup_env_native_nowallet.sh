...
export PACKAGES="python3-zmq clang-7 llvm-7 libc++abi-7-dev libc++-7-dev libboost-all-dev libevent-dev"  # Use clang-7 to test C++17 compatibility, see doc/dependencies.md
